...
Redis:del(RMAD.."nool:flotysb"..Remsg.sender_id.user_id)
...
Redis:incrby(RMAD.."nool:flotysb"..Remsg.sender_id.user_id,denars)
...
Redis:del(RMAD.."nool:flotysb"..UserId_Info.id)
merolua.sendText(msg.chat_id,msg.id, "• تم صفرت فلوسه ","md",true)
end
...
Redis:incrby(RMAD.."nool:flotysb"..UserId_Info.id,denars[1])
...
local GetMd = Redis:get(RMAD.."MyMdaleateamnay"..msg.sender_id.user_id)
if not GetMd then
...
if not Redis:sismember(RMAD.."Akshtd:Games:",TextAksht) then
...
Redis:srem(RMAD.."Akshtd:Games:",TextAksht)
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , Number)
...
local Text = Redis:smembers(RMAD.."Akshtd:Games:") 
if #Text == 0 then
...
Redis:sadd(RMAD.."Akshtd:Games:",Num)
Redis:sadd(RMAD.."Akshtd:Games:",Num1)
Redis:sadd(RMAD.."Akshtd:Games:",Num2)
Redis:sadd(RMAD.."Akshtd:Games:",Num3)
Redis:sadd(RMAD.."Akshtd:Games:",Num4)
Redis:sadd(RMAD.."Akshtd:Games:",Num5)
Redis:sadd(RMAD.."Akshtd:Games:",Num6)
Redis:sadd(RMAD.."Akshtd:Games:",Num7)
Redis:sadd(RMAD.."Akshtd:Games:",Num8)
Redis:sadd(RMAD.."Akshtd:Games:",Num9)
...
local bank_users = Redis:smembers(RMAD.."zrfffidtf")
...
local mony = Redis:get(RMAD.."zrffdcf"..v) or 0
...
fne = Redis:get(RMAD..':toob:Name:'..v[2])
tt =  newss
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(RMAD.."nool:flotysb"..msg.sender_id.user_id) or 0
local bank_users = Redis:smembers(RMAD.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(RMAD.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(RMAD.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(RMAD.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(RMAD..msg_chat_id..v[2].."rgalll2:")
local user_name = merolua.getUser(v[2]).first_name
fne = Redis:get(RMAD..':toob:Name:'..zwga_id)
fnte = Redis:get(RMAD..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(RMAD) then
return merolua.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") then
local zwga_id = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") 
local zoog2 = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") 
local albnt = merolua.getUser(zoog2)
fne = Redis:get(RMAD..':toob:Name:'..zoog2)
albnt = "["..albnt.first_name.."](tg://user?id="..zoog2..") " 
return merolua.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:") then
local zwga_id = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:") 
local zoog2 = Redis:get(RMAD..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = merolua.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(RMAD..msg_chat_id..Message_Reply.sender_id.user_id.."rgalll2:") or Redis:get(RMAD..msg_chat_id..Message_Reply.sender_id.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:") 
Redis:set(RMAD..msg_chat_id..Message_Reply.sender_id.user_id.."bnttt2:", msg.sender_id.user_id)
Redis:set(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:", Message_Reply.sender_id.user_id)
Redis:set(RMAD..msg_chat_id..Message_Reply.sender_id.user_id.."mhrrr2:", UserNameyy)
Redis:set(RMAD..msg_chat_id..msg.sender_id.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , UserNameyy)
Redis:incrby(RMAD.."nool:flotysb"..Message_Reply.sender_id.user_id , UserNameyy)
Redis:incrby(RMAD.."mznom"..msg_chat_id..msg.sender_id.user_id , UserNameyy)
Redis:sadd(RMAD.."almtzog"..msg_chat_id,msg.sender_id.user_id)
return merolua.sendText(msg_chat_id,msg_id,"• مبرووك تم زواجكم\n• الزوج :"..alzog.."\n• الزوجه :"..albnt.."\n• المهر : "..UserNameyy.." بعد خصم 15% \n• لعرض عقدكم اكتبو زواجي","md")
end
if text == "طلاق" and ChCheck(msg) and msg.reply_to_message_id ~= 0 and Redis:get(RMAD..'Alzwag:Chat'..msg.chat_id)  then
local InfoReply = merolua.getMessage(msg.chat_id, msg.reply_to_message_id)
local zogte = Redis:get(RMAD.."zogte"..msg.chat_id..InfoReply.sender_id.user_id)
if not zogte then
return merolua.sendText(msg.chat_id,msg.id,"✯︙العضو ليس لديه زوج","md")
end
Redis:del(RMAD.."zogte"..msg.chat_id..InfoReply.sender_id.user_id,msg.sender_id.user_id)
Redis:del(RMAD.."zogte"..msg.chat_id..msg.sender_id.user_id,InfoReply.sender_id.user_id)
Redis:srem(RMAD.."zogatall"..msg.chat_id,msg.sender_id.user_id)
Redis:srem(RMAD.."zogatall"..msg.chat_id,InfoReply.sender_id.user_id)
return merolua.sendText(msg.chat_id,msg.id,"✯︙تم الطلاق منه","md")
end
if text == "زوجي" and ChCheck(msg) and Redis:get(RMAD..'Alzwag:Chat'..msg.chat_id)  then
local zogte = Redis:get(RMAD.."zogte"..msg.chat_id..msg.sender_id.user_id)
if zogte then
...
if text == "زوجتي" and ChCheck(msg) and Redis:get(RMAD..'Alzwag:Chat'..msg.chat_id)  then
local zogte = Redis:get(RMAD.."zogte"..msg.chat_id..msg.sender_id.user_id)
if zogte then
local UserInfo = merolua.getUser(zogte)
local Teext = "- ["..UserInfo.first_name.."](tg://user?id="..zogte..")"
...
if not Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") and not Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:") then
...
print()
local zoog2 = Redis:get(RMAD..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."mhrrr2:")
local id_rgal = merolua.getUser(zwga_id)
fne = Redis:get(RMAD..':toob:Name:'..zwga_id)
alzog = "["..id_rgal.first_name.."](tg://user?id="..zwga_id..") "
local albnt = merolua.getUser(zoog2)
fnte = Redis:get(RMAD..':toob:Name:'..zoog2)
albnt = "["..albnt.first_name.."](tg://user?id="..zoog2..") "
return merolua.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دينار ","md")
end
if Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") then
local zwga_id = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") 
local zoog2 = Redis:get(RMAD..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."mhrrr2:")
local id_rgal = merolua.getUser(zwga_id)
fnte = Redis:get(RMAD..':toob:Name:'..zwga_id)
albnt = "["..id_rgal.first_name.."](tg://user?id="..zwga_id..") "
local gg = merolua.getUser(zoog2)
fntey = Redis:get(RMAD..':toob:Name:'..zoog2)
alzog = "["..gg.first_name.."](tg://user?id="..zoog2..") "
return merolua.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دينار ","md")
end
end
if text == "خلع" and ChCheck(msg) then
if not Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:") 
Redis:incrby(RMAD.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(RMAD.."nool:flotysb"..msg.sender_id.user_id,mhrr)
Redis:del(RMAD.."mznom"..msg_chat_id..zwga_id)
Redis:srem(RMAD.."almtzog"..msg_chat_id,zwga_id)
Redis:del(RMAD.."mznom"..msg_chat_id..msg.sender_id.user_id)
Redis:srem(RMAD.."almtzog"..msg_chat_id,msg.sender_id.user_id)
Redis:del(RMAD..msg_chat_id..msg.sender_id.user_id.."mhrrr2:")
Redis:del(RMAD..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(RMAD..msg_chat_id..msg.sender_id.user_id.."bnttt2:")
Redis:del(RMAD..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:")
Redis:del(RMAD..msg_chat_id..zwga_id.."rgalll2:")
merolua.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دينار","md")
end
if text == "طالق"  then
if not Redis:get(RMAD..msg_chat_id..msg.sender_id.user_id.."rgalll2:") then
...
Redis:set(RMAD.."MyMdaleateamnay"..v[2],os.date("%Y/%m/%d")..' - ( '..emo..' - '..gflos)
elseif emo == "🥈 )" then
gflos = string.format("%.0f", v[1]):reverse():gsub( "(%d%d%d)" , "%1," ):reverse():gsub("^,","")
Redis:set(RMAD.."MyMdaleateamnay"..v[2],os.date("%Y/%m/%d")..' - ( '..emo..' - '..gflos)
elseif emo == "🥉 )" then
...
local bank_users = Redis:smembers(RMAD.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(RMAD.."nool:flotysb"..v)
Redis:del(RMAD.."zrffdcf"..v)
Redis:del(RMAD.."innoo"..v)
Redis:del(RMAD.."nnooooo"..v)
Redis:del(RMAD.."nnoooo"..v)
Redis:del(RMAD.."nnooo"..v)
Redis:del(RMAD.."nnoo"..v)
Redis:del(RMAD.."polic"..v)
Redis:del(RMAD.."ashmvm"..v)
Redis:del(RMAD.."hrame"..v)
Redis:del(RMAD.."test:mmtlkat6"..v)
Redis:del(RMAD.."zahbmm2"..v)
end
Redis:del(RMAD.."ttpppi")
...
Redis:del(RMAD.."zrfffidtf")
merolua.sendText(msg.chat_id,msg.id, "• مسحت الحراميه ","md",true)
end

--- if bankstok
if not Redis:get(RMAD.."lock_getpankiuser"..msg.chat_id) then
...
balas = 0
if Redis:sismember(RMAD.."noooybgy",msg.sender_id.user_id) then
return merolua.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(RMAD.."nooolb" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
merolua.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(RMAD.."nooolb" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
...
gg = "فيزا"
flossst = Redis:get(RMAD.."nool:flotysb"..msg.sender_id.user_id) or 0
local banid = msg.sender_id.user_id
Redis:set(RMAD.."nonna"..msg.sender_id.user_id,news)
Redis:set(RMAD.."noolb"..msg.sender_id.user_id,creditcc)
Redis:set(RMAD.."nnonb"..msg.sender_id.user_id,text)
Redis:set(RMAD.."nnonbn"..msg.sender_id.user_id,gg)
Redis:set(RMAD.."nonallname"..creditcc,news)
Redis:set(RMAD.."nonallbalc"..creditcc,balas)
Redis:set(RMAD.."nonallcc"..creditcc,creditcc)
Redis:set(RMAD.."nonallban"..creditcc,text)
Redis:set(RMAD.."nonallid"..creditcc,banid)
Redis:sadd(RMAD.."noooybgy",msg.sender_id.user_id)
Redis:del(RMAD.."nooolb" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
...
local banid = msg.sender_id.user_id
Redis:set(RMAD.."nonna"..msg.sender_id.user_id,news)
Redis:set(RMAD.."noolb"..msg.sender_id.user_id,creditvi)
Redis:set(RMAD.."nnonb"..msg.sender_id.user_id,text)
Redis:set(RMAD.."nnonbn"..msg.sender_id.user_id,gg)
Redis:set(RMAD.."nonallname"..creditvi,news)
Redis:set(RMAD.."nonallbalc"..creditvi,balas)
Redis:set(RMAD.."nonallcc"..creditvi,creditvi)
Redis:set(RMAD.."nonallban"..creditvi,text)
Redis:set(RMAD.."nonallid"..creditvi,banid)
Redis:sadd(RMAD.."noooybgy",msg.sender_id.user_id)
Redis:del(RMAD.."nooolb" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
...
local banid = msg.sender_id.user_id
Redis:set(RMAD.."nonna"..msg.sender_id.user_id,news)
Redis:set(RMAD.."noolb"..msg.sender_id.user_id,creditex)
Redis:set(RMAD.."nnonb"..msg.sender_id.user_id,text)
Redis:set(RMAD.."nnonbn"..msg.sender_id.user_id,gg)
Redis:set(RMAD.."nonallname"..creditex,news)
Redis:set(RMAD.."nonallbalc"..creditex,balas)
Redis:set(RMAD.."nonallcc"..creditex,creditex)
Redis:set(RMAD.."nonallban"..creditex,text)
Redis:set(RMAD.."nonallid"..creditex,banid)
Redis:sadd(RMAD.."noooybgy",msg.sender_id.user_id)
Redis:del(RMAD.."nooolb" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
...
if Redis:sismember(RMAD.."noooybgy",msg.sender_id.user_id) then
Redis:srem(RMAD.."noooybgy", msg.sender_id.user_id)
Redis:del(RMAD.."noolb"..msg.sender_id.user_id)
Redis:del(RMAD.."zrffdcf"..msg.sender_id.user_id)
Redis:srem(RMAD.."zrfffidtf", msg.sender_id.user_id)
...
ballanceed = Redis:get(RMAD.."nool:flotysb"..Remsg.sender_id.user_id) or 0
...
if Redis:sismember(RMAD.."noooybgy",Remsg.sender_id.user_id) then
cccc = Redis:get(RMAD.."noolb"..Remsg.sender_id.user_id)
gg = Redis:get(RMAD.."nnonb"..Remsg.sender_id.user_id)
uuuu = Redis:get(RMAD.."nnonbn"..Remsg.sender_id.user_id)
pppp = Redis:get(RMAD.."zrffdcf"..Remsg.sender_id.user_id) or 0
ballancee = Redis:get(RMAD.."nool:flotysb"..Remsg.sender_id.user_id) or 0
...
if Redis:sismember(RMAD.."noooybgy",msg.sender_id.user_id) then
cccc = Redis:get(RMAD.."noolb"..msg.sender_id.user_id)
gg = Redis:get(RMAD.."nnonb"..msg.sender_id.user_id)
uuuu = Redis:get(RMAD.."nnonbn"..msg.sender_id.user_id)
pppp = Redis:get(RMAD.."zrffdcf"..msg.sender_id.user_id) or 0
ballancee = Redis:get(RMAD.."nool:flotysb"..msg.sender_id.user_id) or 0
merolua.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دينار 💸 )\n• السرقه ( "..pppp.." دينار 💸 )\n-","md",true)
else
merolua.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if Redis:get(RMAD.."nnooooo" .. msg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."nnooooo" .. msg.sender_id.user_id)
...
Redis:decrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , ballanceekku)
Redis:setex(RMAD.."nnooooo" .. msg.sender_id.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , math.floor(ballanceekku))
Redis:setex(RMAD.."nnooooo" .. msg.sender_id.user_id,1200, true)
...
if Redis:get(RMAD.."nnoooo" .. msg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."nnoooo" .. msg.sender_id.user_id)
rr = os.date("%M:%S",tonumber(check_time))
...
if Redis:get(RMAD.."xxxr" .. msg.sender_id.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , math.floor(ballanceekk))
Redis:sadd(RMAD.."ttpppi",msg.sender_id.user_id)
Redis:setex(RMAD.."nnoooo" .. msg.sender_id.user_id,1200, true)
...
Redis:del(RMAD.."nool:flotysb"..msg.sender_id.user_id)
merolua.sendText(msg.chat_id,msg.id, "تم تصفير فلوسك","md",true)
end
if text == 'حظ' and ChCheck(msg) then
if Redis:get(RMAD.."nnooo" .. msg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."nnooo" .. msg.sender_id.user_id)
rr = os.date("%M:%S",tonumber(check_time))
...
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , math.floor(ballanceek))
Redis:setex(RMAD.."nnooo" .. msg.sender_id.user_id,1200, true)
ff = Redis:get(RMAD.."nool:flotysb"..msg.sender_id.user_id)
...
Redis:decrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , coniss)
Redis:setex(RMAD.."nnooo" .. msg.sender_id.user_id,1200, true)
ff = Redis:get(RMAD.."nool:flotysb"..msg.sender_id.user_id) or 0
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(RMAD.."noooybgy",msg.sender_id.user_id) then
...
if Redis:get(RMAD.."nonallcc"..text) then
...
local fsvhhh = Redis:get(RMAD.."nonallid"..text)
local bann = merolua.getUser(fsvhhh)
hsabe = Redis:get(RMAD.."nnonb"..fsvhhh)
nouu = Redis:get(RMAD.."nnonbn"..fsvhhh)
...
Redis:incrby(RMAD.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(RMAD.."nool:flotysb"..msg.sender_id.user_id ,UserNamey)
...
if Redis:sismember(RMAD.."noooybgy",msg.sender_id.user_id) then
if Redis:get(RMAD.."nnoo" .. msg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."nnoo" .. msg.sender_id.user_id)
rr = os.date("%M:%S",tonumber(check_time))
return merolua.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(RMAD.."xxxr" .. msg.sender_id.user_id) then
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , 3000)
Redis:sadd(RMAD.."ttpppi",msg.sender_id.user_id)
return merolua.sendText(msg.chat_id,msg.id,"• خذ بخشيش المحظوظين 3000 دينار 💸","md",true)
end
local jjjo = math.random(1,2000);
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , jjjo)
Redis:sadd(RMAD.."ttpppi",msg.sender_id.user_id)
merolua.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دينار 💸","md",true)
Redis:setex(RMAD.."nnoo" .. msg.sender_id.user_id,600, true)
else
merolua.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(RMAD.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(RMAD.."nool:flotysb"..UserId_Info.id) or 0
merolua.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دينار 💸","md",true)
else
...
if Redis:get(RMAD.."polic" .. msg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."polic" .. msg.sender_id.user_id)
rr = os.date("%M:%S",tonumber(check_time))
...
if Redis:get(RMAD.."hrame" .. Remsg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."hrame" .. Remsg.sender_id.user_id)
rr = os.date("%M:%S",tonumber(check_time))
...
local ballanceed = Redis:get(RMAD.."nool:flotysb"..Remsg.sender_id.user_id) or 0
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , hrame)
Redis:decrby(RMAD.."nool:flotysb"..Remsg.sender_id.user_id , hrame)
Redis:sadd(RMAD.."ttpppi",msg.sender_id.user_id)
Redis:setex(RMAD.."hrame" .. Remsg.sender_id.user_id,900, true)
Redis:incrby(RMAD.."zrffdcf"..msg.sender_id.user_id,hrame)
Redis:sadd(RMAD.."zrfffidtf",msg.sender_id.user_id)
...
if Redis:get(RMAD.."hrame" .. UserId_Info.id) then  
local check_time = Redis:ttl(RMAD.."hrame" .. UserId_Info.id)
rr = os.date("%M:%S",tonumber(check_time))
return merolua.sendText(msg.chat_id, msg.id,"• سارقينه قبلك \n• يمديك تسرقهه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(RMAD.."noooybgy",UserId_Info.id) then
...
local hrame = math.random(2000);
local ballanceed = Redis:get(RMAD.."nool:flotysb"..UserId_Info.id) or 0
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , hrame)
Redis:decrby(RMAD.."nool:flotysb"..UserId_Info.id , hrame)
Redis:sadd(RMAD.."ttpppi",msg.sender_id.user_id)
Redis:setex(RMAD.."hrame" .. UserId_Info.id,900, true)
Redis:incrby(RMAD.."zrffdcf"..msg.sender_id.user_id,hrame)
Redis:sadd(RMAD.."zrfffidtf",msg.sender_id.user_id)
Redis:setex(RMAD.."polic" .. msg.sender_id.user_id,300, true)
merolua.sendText(msg.chat_id,msg.id, "• خذ يالحرامي سرقهته "..hrame.." دينار 💸\n","md",true)
...
if Redis:sismember(RMAD.."noooybgy",msg.sender_id.user_id) then
if Redis:get(RMAD.."innoo" .. msg.sender_id.user_id) then  
local check_time = Redis:ttl(RMAD.."innoo" .. msg.sender_id.user_id)
rr = os.date("%M:%S",tonumber(check_time))
...
K = 'محظوظ 2x' 
F = '15000'
Redis:incrby(RMAD.."nool:flotysb"..msg.sender_id.user_id , F)
local ballancee = Redis:get(RMAD.."nool:flotysb"..msg.sender_id.user_id) or 0
local teex = 
Redis:setex(RMAD.."innoo" .. msg.sender_id.user_id,600, true)
